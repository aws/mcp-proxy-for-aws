...
This example demonstrates how to use the MCP Client Library from `mcp-proxy-for-aws` to connect a [LlamaIndex](https://www.llamaindex.ai/) AI agent to an MCP Server on AWS, e.g. using [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/) Runtime or Gateway, using AWS IAM authentication.
...
4. Creates a LlamaIndex agent with access to MCP tools
