...
- **cli**: add --header for extra HTTP headers on signed requests (#411)

### Fixed

- forward server instructions (#416)
...
- set user agent on every request explicitly (#334)

## v1.6.2 (2026-06-19)

### Fixed

- assume role credentials (#325)
...
- `--skip-auth` flag to allow unsigned requests when AWS credentials are unavailable (#260)
