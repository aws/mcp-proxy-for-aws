...
def add_profile_override_middleware(
    mcp: FastMCP, args, service: str, region: str, metadata: dict, timeout: httpx.Timeout
) -> ProfileOverrideMiddleware | None:
    """Add profile override middleware if --allow-switch-profile is set.
    ...
    Returns:
        The middleware instance if added, None otherwise
    """
