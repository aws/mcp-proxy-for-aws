...
class TestServer:
    ...
    def test_create_sigv4_client(self, mock_async_client):
        ...
        not during client creation. Credentials are resolved dynamically per request.
        """
        # Act
    ...
    def test_create_sigv4_client_no_credentials(self):
        ...
        With dynamic credential resolution, client creation never validates credentials.
        Credential validation happens in sign_request_hook when the request is signed.
        """
